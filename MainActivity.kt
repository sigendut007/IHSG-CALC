...
data class StockScanResult(
val ticker: String,
val techScore: Double,
val signal: String,
val muEst: Double,
val coppockLabel: String,
...
val beta: Double,
val momScore: Double,
val isCoppockTurningUp: Boolean,
val volSurge: Double,
val zScore: Double
)
...
// ══════════════════════════════════════════════════════════════
// STOCK UNIVERSE — 5 TIER SCAN MODE (Updated from Excel BEI 2026-06-16)
// Tier 1 : LQ45 equivalent  (~51 saham, curated ultra-liquid)
// Tier 2 : Papan Utama      (269 saham, dari data resmi BEI)
// Tier 3 : Utama+Pengembangan (762 saham, comprehensive)
// Tier 4 : Full IDX          (803 saham, semua non-Pemantauan Khusus)
// Tier 5 : Auto-Fetch        (dinamis dari API BEI, di-cache harian)
// ══════════════════════════════════════════════════════════════

// ── TIER 1 : LQ45 (~51 saham) ─────────────────────────────────
private val IDX_LQ45 = listOf(
// Perbankan
"BBCA","BBRI","BMRI","BRIS","BBNI","BBTN",
// Telekomunikasi & Teknologi
"TLKM","EXCL","ISAT","GOTO","BUKA","EMTK",
// Konsumer Staples & Kesehatan
"UNVR","ICBP","INDF","KLBF","SIDO","HMSP","GGRM","MYOR","ULTJ","MLBI",
// Otomotif & Industri
"ASII","UNTR","AUTO",
// Properti
...
// Semen
"SMGR","INTP",
// Mining, Energi & Komoditas
"ANTM","INCO","PTBA","ITMG","ADRO","BYAN","HRUM","VALE",
"MDKA","AMMN","MEDC","TINS","PGAS","BRMS","BUMI","AKRA",
...
// ── TIER 2 : Papan Utama BEI (269 saham, data resmi 2026-06-16) ───
private val IDX_PAPAN_UTAMA = listOf(
"AADI", "AALI", "ABMM", "ACES", "ADES", "ADHI", "ADMR", "ADRO", "AGRO", "AISA",
"AKRA", "ALDO", "ALII", "AMAG", "AMAR", "AMMN", "AMRT", "ANTM", "APLN", "ARNA",
"ARTO", "ASGR", "ASII", "ASRI", "ASSA", "AUTO", "AVIA", "BACA", "BALI", "BAYU",
"BBCA", "BBHI", "BBMD", "BBNI", "BBRI", "BBSI", "BBTN", "BBYB", "BCAP", "BDKR",
"BDMN", "BEST", "BFIN", "BGTG", "BINA", "BIRD", "BISI", "BJBR", "BJTM", "BKSL",
"BLOG", "BMHS", "BMRI", "BMTR", "BNGA", "BNII", "BNLI", "BOLA", "BREN", "BRIS",
"BRMS", "BRPT", "BSDE", "BSIM", "BSSR", "BTPN", "BTPS", "BUDI", "BUMI", "BVIC",
"BWPT", "BYAN", "CARS", "CASS", "CBDK", "CBUT", "CFIN", "CITA", "CLEO", "CMNP",
"CMRY", "CPIN", "CTRA", "CUAN", "DAAZ", "DEWA", "DGWG", "DILD", "DKFT", "DLTA",
"DMAS", "DMND", "DNET", "DRMA", "DSNG", "DSSA", "ELPI", "ELSA", "EMTK", "ENRG",
"EPMT", "ERAA", "ERAL", "ESSA", "EXCL", "FILM", "FISH", "GEMS", "GGRM", "GJTL",
"GLVA", "GOLF", "GOOD", "GZCO", "HATM", "HEAL", "HERO", "HEXA", "HMSP", "HRTA",
"HRUM", "ICBP", "IMAS", "IMPC", "INCO", "INDF", "INDY", "INKP", "INPC", "INTP",
"IPCC", "IPCM", "ISAT", "ISSP", "ITMG", "JARR", "JIHD", "JKON", "JPFA", "JRPT",
"JSMR", "JSPT", "JTPE", "KBLI", "KEEN", "KEJU", "KIJA", "KKGI", "KLBF", "KOTA",
"KPIG", "LPCK", "LPKR", "LPPF", "LSIP", "LTLS", "MAHA", "MAIN", "MAPA", "MAPI",
"MARK", "MASB", "MAYA", "MBMA", "MBSS", "MCOL", "MCOR", "MDIY", "MDKA", "MDLA",
"MEDC", "MEGA", "MERK", "MIDI", "MIKA", "MKTR", "MLBI", "MLPL", "MNCN", "MORA",
"MPMX", "MSIN", "MSTI", "MTDL", "MTEL", "MTLA", "MTMH", "MYOR", "NISP", "NOBU",
"OMED", "PALM", "PANI", "PANS", "PBID", "PGAS", "PGEO", "PNBN", "PNGO", "PNIN",
"PNLF", "PORT", "POWR", "PRAY", "PRDA", "PSGO", "PSSI", "PTBA", "PTPP", "PTRO",
"PWON", "RAAM", "RAJA", "RALS", "RMKE", "SAME", "SAMF", "SCMA", "SGER", "SGRO",
"SHIP", "SIDO", "SILO", "SIMP", "SKRN", "SMAR", "SMBR", "SMDR", "SMGR", "SMIL",
"SMRA", "SMSM", "SPTO", "SRTG", "SSIA", "SSMS", "STAA", "SUNI", "TAPG", "TBIG",
"TBLA", "TEBE", "TINS", "TKIM", "TLDN", "TLKM", "TMAS", "TOBA", "TOTL", "TOTO",
"TOWR", "TPIA", "TPMA", "TRGU", "TRIM", "TSPC", "TUGU", "UCID", "ULTJ", "UNIC",
"UNTR", "UNVR", "VICI", "VICO", "WIIM", "WINS", "WOOD", "WTON", "YUPI"
)

// ── TIER 3 : Utama + Pengembangan (762 saham, data resmi 2026-06-16) ─
// Tidak termasuk Pemantauan Khusus (saham bermasalah/suspensi)
private val IDX_UTAMA_PENGEMBANGAN = listOf(
"AADI", "AALI", "ABDA", "ABMM", "ACES", "ACRO", "ADCP", "ADES", "ADHI", "ADMF",
"ADMG", "ADMR", "ADRO", "AGAR", "AGII", "AGRO", "AGRS", "AHAP", "AIMS", "AISA",
"AKPI", "AKRA", "AKSI", "ALDO", "ALII", "ALKA", "AMAG", "AMAN", "AMAR", "AMFG",
"AMIN", "AMMN", "AMOR", "AMRT", "ANJT", "ANTM", "APEX", "APIC", "APII", "APLI",
"APLN", "ARCI", "AREA", "ARGO", "ARII", "ARKO", "ARNA", "ARTA", "ARTO", "ASBI",
"ASDM", "ASGR", "ASHA", "ASII", "ASJT", "ASLC", "ASLI", "ASPI", "ASPR", "ASRI",
...
"BLOG", "BLUE", "BMAS", "BMHS", "BMRI", "BMSR", "BMTR", "BNBA", "BNBR", "BNGA",
"BNII", "BNLI", "BOAT", "BOBA", "BOGA", "BOLA", "BOLT", "BPFI", "BPII", "BPTR",
"BRAM", "BREN", "BRIS", "BRMS", "BRNA", "BRPT", "BRRC", "BSBK", "BSDE", "BSIM",
"BSML", "BSSR", "BTON", "BTPN", "BTPS", "BUAH", "BUDI", "BUKK", "BULL", "BUMI",
"BUVA", "BVIC", "BWPT", "BYAN", "CAKK", "CAMP", "CARE", "CARS", "CASA", "CASS",
"CBDK", "CBPE", "CBRE", "CBUT", "CCSI", "CDIA", "CEKA", "CENT", "CFIN", "CGAS",
"CHEK", "CHEM", "CINT", "CITA", "CITY", "CLAY", "CLEO", "CLPI", "CMNP", "CMNT",
"CMRY", "CNMA", "COCO", "COIN", "CPIN", "CPRO", "CRAB", "CRSN", "CSIS", "CSMI",
"CSRA", "CTBN", "CTRA", "CTTH", "CUAN", "CYBR", "DAAZ", "DADA", "DART", "DATA",
"DAYA", "DCII", "DEFI", "DEPO", "DEWA", "DEWI", "DFAM", "DGIK", "DGNS", "DGWG",
"DILD", "DIVA", "DKFT", "DKHH", "DLTA", "DMAS", "DMMX", "DMND", "DNAR", "DNET",
"DOID", "DOOH", "DOSS", "DPNS", "DPUM", "DRMA", "DSFI", "DSNG", "DSSA", "DVLA",
"DWGL", "DYAN", "EAST", "ECII", "EDGE", "EKAD", "ELIT", "ELPI", "ELSA", "EMAS",
"EMDE", "EMTK", "ENAK", "ENRG", "ENZO", "EPAC", "EPMT", "ERAA", "ERAL", "ERTX",
"ESIP", "ESSA", "ESTA", "ESTI", "EXCL", "FAPA", "FAST", "FILM", "FIRE", "FISH",
"FITT", "FMII", "FOLK", "FORE", "FORU", "FPNI", "FUJI", "FUTR", "FWCT", "GDST",
"GDYR", "GEMA", "GEMS", "GGRM", "GGRP", "GHON", "GIAA", "GJTL", "GLVA", "GMFI",
"GMTD", "GOLD", "GOLF", "GOOD", "GOTO", "GPRA", "GPSO", "GRIA", "GRPH", "GSMF",
"GTBO", "GTRA", "GTSI", "GULA", "GUNA", "GWSA", "GZCO", "HAIS", "HALO", "HATM",
"HDFA", "HDIT", "HEAL", "HELI", "HERO", "HEXA", "HGII", "HMSP", "HOKI", "HOMI",
"HOPE", "HRTA", "HRUM", "HUMI", "HYGN", "IATA", "ICBP", "ICON", "IDPR", "IFII",
"IGAR", "IKAN", "IKBI", "IKPM", "IMAS", "IMJS", "IMPC", "INAI", "INCF", "INCI",
"INCO", "INDF", "INDO", "INDR", "INDS", "INDX", "INDY", "INET", "INKP", "INOV",
"INPC", "INPP", "INTD", "INTP", "IOTF", "IPCC", "IPCM", "IPOL", "IRRA", "IRSX",
"ISAT", "ISEA", "ISSP", "ITIC", "ITMA", "ITMG", "JARR", "JAST", "JATI", "JAWA",
"JAYA", "JGLE", "JIHD", "JKON", "JMAS", "JPFA", "JRPT", "JSMR", "JSPT", "JTPE",
"KAEF", "KAQI", "KBLI", "KBLM", "KBLV", "KDSI", "KDTN", "KEEN", "KEJU", "KETR",
"KICI", "KIJA", "KINO", "KIOS", "KJEN", "KKGI", "KLAS", "KLBF", "KMDS", "KMTR",
"KOBX", "KOCI", "KOKA", "KONI", "KOPI", "KOTA", "KPIG", "KRAS", "KRYA", "KSIX",
"KUAS", "LABA", "LABS", "LAJU", "LAND", "LAPD", "LCKM", "LEAD", "LIFE", "LINK",
"LION", "LIVE", "LMPI", "LPCK", "LPGI", "LPIN", "LPKR", "LPLI", "LPPF", "LPPS",
"LRNA", "LSIP", "LTLS", "LUCK", "MAHA", "MAIN", "MAPA", "MAPI", "MARK", "MASB",
"MAXI", "MAYA", "MBAP", "MBMA", "MBSS", "MBTO", "MCAS", "MCOL", "MCOR", "MDIA",
"MDIY", "MDKA", "MDKI", "MDLA", "MDLN", "MEDC", "MEDS", "MEGA", "MERI", "MERK",
"META", "MGNA", "MGRO", "MHKI", "MICE", "MIDI", "MIKA", "MINA", "MINE", "MITI",
"MKAP", "MKPI", "MKTR", "MLBI", "MLPL", "MLPT", "MMIX", "MMLP", "MNCN", "MOLI",
"MORA", "MPIX", "MPMX", "MPOW", "MPRO", "MPXL", "MRAT", "MREI", "MSIN", "MSJA",
"MSKY", "MSTI", "MTDL", "MTEL", "MTLA", "MTMH", "MTWI", "MUTU", "MYOH", "MYOR",
"NAIK", "NASI", "NATO", "NCKL", "NELY", "NEST", "NETV", "NFCX", "NICE", "NICK",
"NICL", "NIKL", "NIRO", "NISP", "NOBU", "NPGF", "NRCA", "NSSS", "NTBK", "NZIA",
"OASA", "OBAT", "OBMD", "OILS", "OKAS", "OMED", "OMRE", "OPMS", "PADA", "PADI",
"PALM", "PAMG", "PANI", "PANR", "PANS", "PART", "PBID", "PBSA", "PDES", "PDPP",
"PEGE", "PEHA", "PEVE", "PGAS", "PGEO", "PGLI", "PGUN", "PICO", "PIPA", "PJAA",
"PJHB", "PKPK", "PMJS", "PMUI", "PNBN", "PNBS", "PNGO", "PNIN", "PNLF", "PNSE",
"POLA", "POLI", "POLU", "PORT", "POWR", "PPRE", "PPRI", "PRAY", "PRDA", "PRIM",
"PSAB", "PSAT", "PSDN", "PSGO", "PSKT", "PSSI", "PTBA", "PTIS", "PTMP", "PTPP",
"PTPS", "PTPW", "PTRO", "PTSN", "PTSP", "PUDP", "PURI", "PWON", "PYFA", "PZZA",
"RAAM", "RAJA", "RALS", "RANC", "RATU", "RBMS", "RDTX", "REAL", "RELI", "RGAS",
"RICY", "RIGS", "RISE", "RLCO", "RMKE", "RMKO", "ROCK", "RODA", "RONY", "ROTI",
"RSCH", "RSGK", "RUIS", "SAFE", "SAME", "SAMF", "SAPX", "SATU", "SBMA", "SCCO",
"SCMA", "SCNP", "SDMU", "SDPC", "SDRA", "SEMA", "SFAN", "SGER", "SGRO", "SHID",
"SHIP", "SICO", "SIDO", "SILO", "SIMP", "SIPD", "SKBM", "SKLT", "SKRN", "SLIS",
"SMAR", "SMBR", "SMDM", "SMDR", "SMGA", "SMGR", "SMIL", "SMKL", "SMLE", "SMMA",
"SMMT", "SMRA", "SMSM", "SNLK", "SOCI", "SOHO", "SOLA", "SONA", "SOTS", "SPMA",
"SPTO", "SRAJ", "SRSN", "SRTG", "SSIA", "SSMS", "SSTM", "STAA", "STAR", "STRK",
"STTP", "SULI", "SUNI", "SUPA", "SURE", "SURI", "SWID", "TALF", "TAMA", "TAPG",
"TAYS", "TBIG", "TBLA", "TBMS", "TCID", "TCPI", "TEBE", "TFAS", "TGKA", "TIFA",
"TINS", "TIRA", "TKIM", "TLDN", "TLKM", "TMAS", "TMPO", "TNCA", "TOBA", "TOOL",
"TOSK", "TOTL", "TOTO", "TOWR", "TPIA", "TPMA", "TRGU", "TRIM", "TRIN", "TRIS",
"TRJA", "TRON", "TRST", "TRUE", "TRUK", "TRUS", "TSPC", "TUGU", "TYRE", "UANG",
"UCID", "UFOE", "ULTJ", "UNIC", "UNIQ", "UNIT", "UNTD", "UNTR", "UNVR", "UVCR",
"VAST", "VERN", "VICI", "VICO", "VINS", "VISI", "VKTR", "VOKS", "VRNA", "VTNY",
"WAPO", "WBSA", "WEGE", "WEHA", "WIFI", "WIIM", "WINE", "WINS", "WIRG", "WMUU",
"WOMF", "WOOD", "WOWS", "WTON", "YELO", "YOII", "YPAS", "YULE", "YUPI", "ZATA",
"ZONE", "ZYRX"
)

// ── TIER 4 : Full IDX non-Pemantauan Khusus (803 saham, termasuk Akselerasi) ─
// Mencakup Papan Utama + Pengembangan + Akselerasi + Ekonomi Baru
// Pemantauan Khusus (154 saham bermasalah) DIKECUALIKAN
private val IDX_FULL_NON_KHUSUS = listOf(
"AADI", "AALI", "ABDA", "ABMM", "ACES", "ACRO", "ADCP", "ADES", "ADHI", "ADMF",
"ADMG", "ADMR", "ADRO", "AEGS", "AGAR", "AGII", "AGRO", "AGRS", "AHAP", "AIMS",
"AISA", "AKPI", "AKRA", "AKSI", "ALDO", "ALII", "ALKA", "AMAG", "AMAN", "AMAR",
"AMFG", "AMIN", "AMMN", "AMMS", "AMOR", "AMRT", "ANJT", "ANTM", "APEX", "APIC",
"APII", "APLI", "APLN", "ARCI", "AREA", "ARGO", "ARII", "ARKO", "ARNA", "ARTA",
"ARTO", "ASBI", "ASDM", "ASGR", "ASHA", "ASII", "ASJT", "ASLC", "ASLI", "ASPI",
"ASPR", "ASRI", "ASRM", "ASSA", "ATAP", "ATIC", "ATLA", "AUTO", "AVIA", "AWAN",
"AXIO", "AYAM", "AYLS", "BABP", "BABY", "BACA", "BAIK", "BAJA", "BALI", "BANK",
"BAPA", "BATR", "BAYU", "BBCA", "BBHI", "BBKP", "BBLD", "BBMD", "BBNI", "BBRI",
"BBRM", "BBSI", "BBSS", "BBTN", "BBYB", "BCAP", "BCIC", "BCIP", "BDKR", "BDMN",
"BEEF", "BEER", "BELI", "BELL", "BESS", "BEST", "BFIN", "BGTG", "BHAT", "BIKE",
"BINA", "BINO", "BIPI", "BIPP", "BIRD", "BISI", "BJBR", "BJTM", "BKDP", "BKSL",
"BKSW", "BLES", "BLOG", "BLUE", "BMAS", "BMBL", "BMHS", "BMRI", "BMSR", "BMTR",
"BNBA", "BNBR", "BNGA", "BNII", "BNLI", "BOAT", "BOBA", "BOGA", "BOLA", "BOLT",
"BPFI", "BPII", "BPTR", "BRAM", "BREN", "BRIS", "BRMS", "BRNA", "BRPT", "BRRC",
"BSBK", "BSDE", "BSIM", "BSML", "BSSR", "BTON", "BTPN", "BTPS", "BUAH", "BUDI",
"BUKA", "BUKK", "BULL", "BUMI", "BUVA", "BVIC", "BWPT", "BYAN", "CAKK", "CAMP",
"CARE", "CARS", "CASA", "CASH", "CASS", "CBDK", "CBPE", "CBRE", "CBUT", "CCSI",
"CDIA", "CEKA", "CENT", "CFIN", "CGAS", "CHEK", "CHEM", "CHIP", "CINT", "CITA",
"CITY", "CLAY", "CLEO", "CLPI", "CMNP", "CMNT", "CMRY", "CNMA", "COCO", "COIN",
"CPIN", "CPRO", "CRAB", "CRSN", "CSIS", "CSMI", "CSRA", "CTBN", "CTRA", "CTTH",
"CUAN", "CYBR", "DAAZ", "DADA", "DART", "DATA", "DAYA", "DCII", "DEFI", "DEPO",
"DEWA", "DEWI", "DFAM", "DGIK", "DGNS", "DGWG", "DILD", "DIVA", "DKFT", "DKHH",
"DLTA", "DMAS", "DMMX", "DMND", "DNAR", "DNET", "DOID", "DOOH", "DOSS", "DPNS",
"DPUM", "DRMA", "DSFI", "DSNG", "DSSA", "DVLA", "DWGL", "DYAN", "EAST", "ECII",
"EDGE", "EKAD", "ELIT", "ELPI", "ELSA", "EMAS", "EMDE", "EMTK", "ENAK", "ENRG",
"ENZO", "EPAC", "EPMT", "ERAA", "ERAL", "ERTX", "ESIP", "ESSA", "ESTA", "ESTI",
"EURO", "EXCL", "FAPA", "FAST", "FILM", "FIRE", "FISH", "FITT", "FLMC", "FMII",
"FOLK", "FORE", "FORU", "FPNI", "FUJI", "FUTR", "FWCT", "GDST", "GDYR", "GEMA",
"GEMS", "GGRM", "GGRP", "GHON", "GIAA", "GJTL", "GLVA", "GMFI", "GMTD", "GOLD",
"GOLF", "GOOD", "GOTO", "GPRA", "GPSO", "GRIA", "GRPH", "GRPM", "GSMF", "GTBO",
"GTRA", "GTSI", "GULA", "GUNA", "GWSA", "GZCO", "HAIS", "HAJJ", "HALO", "HATM",
"HBAT", "HDFA", "HDIT", "HEAL", "HELI", "HERO", "HEXA", "HGII", "HMSP", "HOKI",
"HOMI", "HOPE", "HRTA", "HRUM", "HUMI", "HYGN", "IATA", "IBOS", "ICBP", "ICON",
"IDEA", "IDPR", "IFII", "IGAR", "IKAN", "IKBI", "IKPM", "IMAS", "IMJS", "IMPC",
"INAI", "INCF", "INCI", "INCO", "INDF", "INDO", "INDR", "INDS", "INDX", "INDY",
"INET", "INKP", "INOV", "INPC", "INPP", "INTD", "INTP", "IOTF", "IPAC", "IPCC",
"IPCM", "IPOL", "IRRA", "IRSX", "ISAP", "ISAT", "ISEA", "ISSP", "ITIC", "ITMA",
"ITMG", "JARR", "JAST", "JATI", "JAWA", "JAYA", "JGLE", "JIHD", "JKON", "JMAS",
"JPFA", "JRPT", "JSMR", "JSPT", "JTPE", "KAEF", "KAQI", "KBLI", "KBLM", "KBLV",
"KDSI", "KDTN", "KEEN", "KEJU", "KETR", "KICI", "KIJA", "KINO", "KIOS", "KJEN",
"KKGI", "KLAS", "KLBF", "KLIN", "KMDS", "KMTR", "KOBX", "KOCI", "KOKA", "KONI",
"KOPI", "KOTA", "KPIG", "KRAS", "KRYA", "KSIX", "KUAS", "LABA", "LABS", "LAJU",
"LAND", "LAPD", "LCKM", "LEAD", "LFLO", "LIFE", "LINK", "LION", "LIVE", "LMAX",
"LMPI", "LOPI", "LPCK", "LPGI", "LPIN", "LPKR", "LPLI", "LPPF", "LPPS", "LRNA",
"LSIP", "LTLS", "LUCK", "LUCY", "MAHA", "MAIN", "MANG", "MAPA", "MAPI", "MARK",
"MASB", "MAXI", "MAYA", "MBAP", "MBMA", "MBSS", "MBTO", "MCAS", "MCOL", "MCOR",
"MDIA", "MDIY", "MDKA", "MDKI", "MDLA", "MDLN", "MEDC", "MEDS", "MEGA", "MEJA",
"MERI", "MERK", "META", "MGLV", "MGNA", "MGRO", "MHKI", "MICE", "MIDI", "MIKA",
"MINA", "MINE", "MITI", "MKAP", "MKPI", "MKTR", "MLBI", "MLPL", "MLPT", "MMIX",
"MMLP", "MNCN", "MOLI", "MORA", "MPIX", "MPMX", "MPOW", "MPRO", "MPXL", "MRAT",
"MREI", "MSIE", "MSIN", "MSJA", "MSKY", "MSTI", "MTDL", "MTEL", "MTLA", "MTMH",
"MTWI", "MUTU", "MYOH", "MYOR", "NAIK", "NANO", "NASI", "NATO", "NAYZ", "NCKL",
"NELY", "NEST", "NETV", "NFCX", "NICE", "NICK", "NICL", "NIKL", "NINE", "NIRO",
"NISP", "NOBU", "NPGF", "NRCA", "NSSS", "NTBK", "NZIA", "OASA", "OBAT", "OBMD",
"OILS", "OKAS", "OLIV", "OMED", "OMRE", "OPMS", "PACK", "PADA", "PADI", "PALM",
"PAMG", "PANI", "PANR", "PANS", "PART", "PBID", "PBSA", "PDES", "PDPP", "PEGE",
"PEHA", "PEVE", "PGAS", "PGEO", "PGLI", "PGUN", "PICO", "PIPA", "PJAA", "PJHB",
"PKPK", "PLAN", "PMJS", "PMUI", "PNBN", "PNBS", "PNGO", "PNIN", "PNLF", "PNSE",
"POLA", "POLI", "POLU", "PORT", "POWR", "PPGL", "PPRE", "PPRI", "PRAY", "PRDA",
"PRIM", "PSAB", "PSAT", "PSDN", "PSGO", "PSKT", "PSSI", "PTBA", "PTIS", "PTMP",
"PTPP", "PTPS", "PTPW", "PTRO", "PTSN", "PTSP", "PUDP", "PURI", "PWON", "PYFA",
"PZZA", "RAAM", "RAJA", "RALS", "RANC", "RATU", "RBMS", "RCCC", "RDTX", "REAL",
"RELF", "RELI", "RGAS", "RICY", "RIGS", "RISE", "RLCO", "RMKE", "RMKO", "ROCK",
"RODA", "RONY", "ROTI", "RSCH", "RSGK", "RUIS", "RUNS", "SAFE", "SAME", "SAMF",
"SAPX", "SATU", "SBMA", "SCCO", "SCMA", "SCNP", "SDMU", "SDPC", "SDRA", "SEMA",
"SFAN", "SGER", "SGRO", "SHID", "SHIP", "SICO", "SIDO", "SILO", "SIMP", "SIPD",
"SKBM", "SKLT", "SKRN", "SLIS", "SMAR", "SMBR", "SMDM", "SMDR", "SMGA", "SMGR",
"SMIL", "SMKL", "SMKM", "SMLE", "SMMA", "SMMT", "SMRA", "SMSM", "SNLK", "SOCI",
"SOFA", "SOHO", "SOLA", "SONA", "SOTS", "SOUL", "SPMA", "SPRE", "SPTO", "SRAJ",
"SRSN", "SRTG", "SSIA", "SSMS", "SSTM", "STAA", "STAR", "STRK", "STTP", "SULI",
"SUNI", "SUPA", "SURE", "SURI", "SWID", "TALF", "TAMA", "TAPG", "TAYS", "TBIG",
...
"TRST", "TRUE", "TRUK", "TRUS", "TSPC", "TUGU", "TYRE", "UANG", "UCID", "UDNG",
"UFOE", "ULTJ", "UNIC", "UNIQ", "UNIT", "UNTD", "UNTR", "UNVR", "UVCR", "VAST",
...
// ── CACHE KEYS untuk Auto-Fetch ──────────────────────────────
private val IDX_CACHE_PREF        = "IDXDynamicCache"
private val IDX_CACHE_LIST_KEY    = "idx_dynamic_tickers"
private val IDX_CACHE_DATE_KEY    = "idx_dynamic_date"
private val IDX_CACHE_COUNT_KEY   = "idx_dynamic_count"

// ═══════════════════════════════════════════════════════════════
// AUTO-FETCH: AMBIL DAFTAR SAHAM DARI API BEI SECARA DINAMIS
// Cache 1 hari di SharedPreferences — fallback ke static list
// ═══════════════════════════════════════════════════════════════

/**
* Mengambil daftar semua saham BEI dari API resmi idx.co.id.
* Filter: hanya saham dari Papan Utama, Pengembangan, Akselerasi & Ekonomi Baru.
* Papan Pemantauan Khusus (suspensi/bermasalah) otomatis dikecualikan.
*
* @return List<String> kode saham, atau null jika fetch gagal
*/
private fun fetchIDXStockListFromAPI(): List<String>? {
val endpoints = listOf(
// Endpoint 1: IDX official API
...
// Endpoint 2: IDX alternative language param
...
conn.setRequestProperty("Referer", "https://www.idx.co.id/id/data-pasar/data-saham/daftar-saham/")
...
val excludedBoards = setOf(
"pemantauanKhusus", "PemantauanKhusus", "pemantauan_khusus",
"monitoring", "special_monitoring"
)
val tickers = mutableListOf<String>()
for (i in 0 until dataArr.length()) {
val item = dataArr.getJSONObject(i)
// Code field might be "Code", "code", or "KodeSaham"
val code = (item.optString("Code", "")
.ifEmpty { item.optString("code","") }
.ifEmpty { item.optString("KodeSaham","") }).trim()
if (code.isEmpty() || code.length > 6) continue

// Board exclusion
val board = item.optString("BoardId","")
.ifEmpty { item.optString("Board","") }
.ifEmpty { item.optString("boardId","") }
if (board in excludedBoards) continue

tickers.add(code)
}

if (tickers.size >= 100) return tickers.distinct().sorted()
...
/**
* Ambil list dinamis dengan cache harian.
* Jika cache masih fresh (< 24 jam), return cache.
* Jika cache expired / tidak ada, fetch dari API.
* Jika fetch gagal, fallback ke IDX_FULL_NON_KHUSUS (static).
*/
private fun getDynamicIDXList(forceRefresh: Boolean = false): Pair<List<String>, String> {
val prefs    = getSharedPreferences(IDX_CACHE_PREF, MODE_PRIVATE)
val cachedStr = prefs.getString(IDX_CACHE_LIST_KEY, null)
val cachedDate = prefs.getString(IDX_CACHE_DATE_KEY, "")
val sdf      = makeSdfDate()
val todayKey = sdf.format(Calendar.getInstance(WIB).time)

if (!forceRefresh && cachedStr != null && cachedDate == todayKey) {
val cached = cachedStr.split(",").map { it.trim() }.filter { it.isNotEmpty() }
if (cached.size >= 100) {
return cached to "✅ Cache hari ini ($todayKey) — ${cached.size} saham"
}
}

// Fetch from API
val fetched = fetchIDXStockListFromAPI()
return if (fetched != null && fetched.size >= 100) {
val joined = fetched.joinToString(",")
prefs.edit()
.putString(IDX_CACHE_LIST_KEY, joined)
.putString(IDX_CACHE_DATE_KEY, todayKey)
.putInt(IDX_CACHE_COUNT_KEY, fetched.size)
.apply()
fetched to "🌐 Fresh dari API BEI ($todayKey) — ${fetched.size} saham"
} else {
// Fallback to static full list
IDX_FULL_NON_KHUSUS to "⚠ API gagal — pakai static list (803 saham)"
}
}
...
// ── Top 10 Saham IDX — Technical Scanner ──────────────────
val topStocksBtn = Button(this).apply {
text = "🏆 TOP 10 SAHAM BESOK  (IDX Technical Scan)"
setBackgroundColor(Color.parseColor("#4A148C")); setTextColor(Color.WHITE)
textSize = 13f; paint.isFakeBoldText = true
val lp = LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT)
lp.setMargins(0, 8, 0, 0); layoutParams = lp
}
topStocksBtn.setOnClickListener { showTopStocksDialog() }
layout.addView(topStocksBtn)
...
// ═══════════════════════════════════════════════════════════════
// COPPOCK CURVE FUNCTIONS
// ═══════════════════════════════════════════════════════════════

private fun wma(data: List<Double>, period: Int): Double {
val recent = data.takeLast(period.coerceAtMost(data.size))
if (recent.isEmpty()) return 0.0
var wSum = 0.0; var wTot = 0.0
recent.forEachIndexed { i, v -> val w = (i + 1).toDouble(); wSum += v * w; wTot += w }
return wSum / wTot.coerceAtLeast(1.0)
}

private fun roc(prices: List<Double>, period: Int): List<Double> {
if (prices.size <= period) return emptyList()
return (period until prices.size).map { i ->
val base = prices[i - period]
if (base > 0.0) (prices[i] - base) / base * 100.0 else 0.0
}
}

private fun coppockCurve(
prices: List<Double>,
rP1: Int = 14, rP2: Int = 11, wP: Int = 10
): Pair<Double, Double> {
val minNeeded = maxOf(rP1, rP2) + wP + 2
if (prices.size < minNeeded) return 0.0 to 0.0
val r1 = roc(prices, rP1)
val r2 = roc(prices, rP2)
val minLen = minOf(r1.size, r2.size)
if (minLen < wP + 2) return 0.0 to 0.0
val combined = (0 until minLen).map { i ->
r1[r1.size - minLen + i] + r2[r2.size - minLen + i]
}
val current  = wma(combined, wP)
val previous = wma(combined.dropLast(1), wP)
...
private val FACTOR_KEYS = listOf("Momentum","AI_Senti","MeanRev","Broker","Beta_IHSG","Coppock")

private fun defaultWeights(regime: String): Map<String, Double> = when (regime) {
"STABLE BULLISH"           -> mapOf("Momentum" to 0.22,"AI_Senti" to 0.18,"MeanRev" to 0.10,"Broker" to 0.25,"Beta_IHSG" to 0.12,"Coppock" to 0.13)
"VOLATILE UPTREND"         -> mapOf("Momentum" to 0.25,"AI_Senti" to 0.14,"MeanRev" to 0.10,"Broker" to 0.27,"Beta_IHSG" to 0.14,"Coppock" to 0.10)
"HIGH-STRESS PANIC"        -> mapOf("Momentum" to 0.12,"AI_Senti" to 0.18,"MeanRev" to 0.20,"Broker" to 0.20,"Beta_IHSG" to 0.12,"Coppock" to 0.18)
"SIDEWAYS / CONSOLIDATION" -> mapOf("Momentum" to 0.12,"AI_Senti" to 0.18,"MeanRev" to 0.25,"Broker" to 0.20,"Beta_IHSG" to 0.10,"Coppock" to 0.15)
"BEARISH ACCUMULATION"     -> mapOf("Momentum" to 0.17,"AI_Senti" to 0.18,"MeanRev" to 0.17,"Broker" to 0.21,"Beta_IHSG" to 0.12,"Coppock" to 0.15)
else                       -> mapOf("Momentum" to 0.20,"AI_Senti" to 0.18,"MeanRev" to 0.13,"Broker" to 0.22,"Beta_IHSG" to 0.12,"Coppock" to 0.15)
}
...
dateAdjMap: Map<String, Double> = emptyMap()
): LearningReport {
val prefs   = getSharedPreferences("RegimeMemory", MODE_PRIVATE)
...
val (coppockStd,  coppockStdPrev)  = coppockCurve(s.adj, 14, 11, 10)
val (coppockFast, coppockFastPrev) = coppockCurve(s.adj,  6,  4,  5)
val coppockStdRising   = coppockStd  > coppockStdPrev
val coppockFastRising  = coppockFast > coppockFastPrev
val coppockTurningUp   = coppockStdRising  && coppockStdPrev  <= 0.0
val coppockTurningDown = !coppockStdRising && coppockStdPrev  >= 0.0
val coppockDirBase = when {
coppockTurningUp                    ->  1.0
coppockStd > 0 && coppockStdRising  ->  0.70
coppockStd <= 0 && coppockStdRising ->  0.40
coppockTurningDown                  -> -1.0
coppockStd > 0 && !coppockStdRising -> -0.30
else                               -> -0.70
}
val coppockFastConf = if (coppockFastRising == coppockStdRising) 1.10 else 0.90
val coppockDirScore = (coppockDirBase * coppockFastConf).coerceIn(-1.0, 1.0)
val coppockMagScore = normalizeSignal(coppockStd, 18.0)
val coppockNorm = (coppockDirScore * 0.65 + coppockMagScore * 0.35).coerceIn(-1.0, 1.0)

val wMomentumBase=currentWeights["Momentum"]?:0.20; val wAIBase=currentWeights["AI_Senti"]?:0.18
val wMRBase=currentWeights["MeanRev"]?:0.13; val wBetaBase=currentWeights["Beta_IHSG"]?:0.12
val wBrokerBase=currentWeights["Broker"]?:0.22; val wCoppockBase=currentWeights["Coppock"]?:0.15
...
val wBeta=wBetaBase
val wCoppock = when {
coppockStd == 0.0 && coppockStdPrev == 0.0 -> 0.0
coppockTurningUp || coppockTurningDown      -> (wCoppockBase * 1.30).coerceAtMost(WEIGHT_MAX)
else                                        -> wCoppockBase
}

val wTotal=(wMomentum+wAI+wMR+wBroker+wBeta+wCoppock).coerceAtLeast(0.0001)
val wMomentumN=wMomentum/wTotal; val wAIN=wAI/wTotal; val wMRN=wMR/wTotal
val wBrokerN=wBroker/wTotal; val wBetaN=wBeta/wTotal; val wCoppockN=wCoppock/wTotal
...
val confCoppock=((when {
coppockStd == 0.0 && coppockStdPrev == 0.0 -> 0.0
coppockTurningUp || coppockTurningDown      -> 0.92
coppockStd != 0.0                          -> 0.68
else                                       -> 0.45
})*accMul("Coppock")).coerceIn(0.0,1.0)
...
FactorSignal("Coppock",coppockNorm,wCoppockN,confCoppock)
)
...
val coppockSnapBreakout = when {
coppockTurningUp                    -> 0.958
coppockStd > 0 && coppockStdRising  -> 0.968
coppockStd <= 0 && coppockStdRising -> 0.975
else                               -> 0.979
}
val coppockSnapSupport = when {
coppockTurningUp                    -> 0.945
coppockStd > 0 && coppockStdRising  -> 0.958
coppockStd <= 0 && coppockStdRising -> 0.965
else                               -> 0.970
}
val coppockSnapSell = when {
coppockTurningDown                  -> 1.035
!coppockStdRising && coppockStd > 0 -> 1.038
coppockTurningUp                    -> 1.045
else                               -> 1.040
}
val coppockFallBuyMult = when {
coppockTurningUp                    -> 0.04
coppockStd > 0 && coppockStdRising  -> 0.10
coppockStd <= 0 && coppockStdRising -> 0.17
else                               -> 0.22
}
val coppockFallSellMult = when {
coppockTurningDown                  -> 0.06
!coppockStdRising && coppockStd > 0 -> 0.12
else                               -> 0.15
}
val coppockEntryTag = when {
coppockTurningUp                    -> "⚡ AGRESIF  [Coppock Turning Up]"
coppockStd > 0 && coppockStdRising  -> "✅ NORMAL  [Coppock Rising+]"
coppockStd <= 0 && coppockStdRising -> "⚠ KONSERVATIF  [Coppock Recovering]"
coppockTurningDown                  -> "🔽 DEFENSIF  [Coppock Turning Down]"
else                               -> "↓ DEFENSIF  [Coppock Bearish]"
}
...
val e = listOf(s1, pivot)
.filter { it < lastAdj && it > lastAdj * coppockSnapBreakout }
.maxOrNull() ?: (lastAdj * (1 - coppockFallBuyMult * sigmaFinal))
TradePlan("BUY", e, "BUY Entry ▲  Breakout | $coppockEntryTag", Color.parseColor("#004D40"))
}
isBuySetup -> {
val e = listOf(s1, s2, sup20)
.filter { it < lastAdj && it > lastAdj * coppockSnapSupport }
.maxOrNull() ?: (lastAdj * (1 - coppockFallBuyMult * sigmaFinal))
TradePlan("BUY", e, "BUY Entry ▲  Support-Snap | $coppockEntryTag", Color.parseColor("#004D40"))
}
isSellSetup -> {
val e = listOf(r1, r2, res20)
.filter { it > lastAdj && it < lastAdj * coppockSnapSell }
.minOrNull() ?: (lastAdj * (1 + coppockFallSellMult * sigmaFinal))
TradePlan("SELL", e, "SELL Entry ▼  Resistance | $coppockEntryTag", Color.parseColor("#B71C1C"))
}
...
setBackgroundColor(Color.parseColor("#263238")); setTextColor(Color.WHITE)
textSize = 13f; paint.isFakeBoldText = true; setPadding(20, 14, 20, 14)
...
val brokerContent = LinearLayout(this).apply { orientation = LinearLayout.VERTICAL; visibility = android.view.View.VISIBLE }
brokerToggleBtn.setOnClickListener {
if (brokerContent.visibility == android.view.View.VISIBLE) {
brokerContent.visibility = android.view.View.GONE; brokerToggleBtn.text = "▶  BROKER SUMMARY ANALYSIS  (tap untuk tampilkan)"
} else {
brokerContent.visibility = android.view.View.VISIBLE; brokerToggleBtn.text = "▼  BROKER SUMMARY ANALYSIS  (tap untuk sembunyikan)"
}
}
val bCol=when {
...
text = "Signal: ${brokerSummary.brokerSignal}"; setTextColor(bCol); textSize = 15f; paint.isFakeBoldText = true; setPadding(10, 8, 10, 5)
})
fun bLabel(t: String, c: Int) = addLabelToLayout(brokerContent, t, c)
bLabel("Net Flow: ${String.format("%,d",brokerSummary.netFlowLot)} lot | Freq: ${brokerSummary.netFlowFreq}", if(brokerSummary.netFlowLot>0) Color.parseColor("#2E7D32") else Color.RED)
...
bLabel("Freq Imb: ${"%.1f".format(fip)}% (${if(fip>5)"Buy Dom" else if(fip<-5)"Sell Dom" else "Balanced"}) | Inst: ${"%.3f".format(brokerSummary.institutionalScore)}", if(fip>5) Color.parseColor("#2E7D32") else if(fip<-5) Color.RED else Color.DKGRAY)
bLabel("Whale (adaptive): ${if(brokerSummary.whalePresence)"✔ DETECTED" else "✘ None"}", if(brokerSummary.whalePresence) Color.parseColor("#E65100") else Color.DKGRAY)
if (brokerSummary.wAvgBuyPrice>0||brokerSummary.wAvgSellPrice>0) {
addSubHeaderToLayout(brokerContent,"  ▸ AVG PRICE ANALYSIS")
if (brokerSummary.wAvgBuyPrice>0) { val gap=(lastAdj-brokerSummary.wAvgBuyPrice)/brokerSummary.wAvgBuyPrice*100; bLabel("  Avg Buy: ${brokerSummary.wAvgBuyPrice.toInt()} | ${"%.1f".format(gap)}% ${if(gap>0)"PROFIT ✅" else "RUGI ❌"}", if(gap>0) Color.parseColor("#2E7D32") else Color.RED) }
if (brokerSummary.wAvgSellPrice>0) { val gap=(brokerSummary.wAvgSellPrice-lastAdj)/brokerSummary.wAvgSellPrice*100; bLabel("  Avg Sell: ${brokerSummary.wAvgSellPrice.toInt()} | Seller ${"%.1f".format(gap)}% ${if(gap>0)"PROFIT ✅" else "RUGI ❌"}", if(gap>0) Color.parseColor("#1B5E20") else Color.parseColor("#B71C1C")) }
...
} else { bLabel("  ℹ️ Avg price tidak terdeteksi → coba scan ulang atau isi manual",Color.DKGRAY) }
if (brokerSummary.topBuyers.isNotEmpty()) { addSubHeaderToLayout(brokerContent,"  ▸ TOP BUYER"); brokerSummary.topBuyers.forEach { b -> val ps=if(b.avgBuyPrice>0)" @${b.avgBuyPrice.toInt()}" else ""; bLabel("  [${b.brokerCode}] ${String.format("%,d",b.buyLot)}L/${b.buyFreq}tx (avg ${b.avgBuyLot.toInt()}L$ps) | ${b.dominance}",Color.parseColor("#1B5E20")) } }
if (brokerSummary.topSellers.isNotEmpty()) { addSubHeaderToLayout(brokerContent,"  ▸ TOP SELLER"); brokerSummary.topSellers.forEach { b -> val ps=if(b.avgSellPrice>0)" @${b.avgSellPrice.toInt()}" else ""; bLabel("  [${b.brokerCode}] ${String.format("%,d",b.sellLot)}L/${b.sellFreq}tx (avg ${b.avgSellLot.toInt()}L$ps) | ${b.dominance}",Color.RED) } }
parent.addView(brokerToggleBtn); parent.addView(brokerContent)
}
...
addHeader(parent,"===== MOMENTUM, MEAN-REVERSION & COPPOCK =====")
...
val coppockLabel = when {
coppockStd == 0.0 && coppockStdPrev == 0.0 -> "— (data belum cukup)"
coppockTurningUp                            -> "🔼 TURNING UP ← SINYAL BELI KLASIK ✅"
coppockTurningDown                          -> "🔽 TURNING DOWN ← SINYAL JUAL KLASIK ❌"
coppockStd > 0 && coppockStdRising          -> "↑ Rising Positive (tren naik sehat)"
coppockStd > 0 && !coppockStdRising         -> "↓ Falling Positive (melemah, waspadai)"
coppockStd <= 0 && coppockStdRising         -> "↑ Recovering (naik dari negatif)"
else                                        -> "↓ Falling Negative (tren turun)"
}
val coppockCol = when {
coppockTurningUp                    -> Color.parseColor("#1B5E20")
coppockStd > 0 && coppockStdRising  -> Color.parseColor("#2E7D32")
coppockStd <= 0 && coppockStdRising -> Color.parseColor("#E65100")
coppockTurningDown                  -> Color.parseColor("#B71C1C")
else                                -> Color.RED
}
addLabel(parent,"Coppock Std (14,11,10): ${"%.3f".format(coppockStd)} | Prev: ${"%.3f".format(coppockStdPrev)}",coppockCol).apply{(this as TextView).paint.isFakeBoldText=true}
addLabel(parent,"  → $coppockLabel",coppockCol)
addLabel(parent,"Coppock Fast(6,4,5): ${"%.3f".format(coppockFast)} | ${if(coppockFastRising)"↑ Rising" else "↓ Falling"} | FastConf: ${if(coppockFastRising==coppockStdRising)"✅ Aligned +10%" else "⚠ Diverge −10%"}",Color.DKGRAY)
addLabel(parent,"Coppock Signal: ${"%.3f".format(coppockNorm)} | w=${"%.0f".format(wCoppockN*100)}% | conf=${"%.0f".format(confCoppock*100)}%",coppockCol)
...
// ═══════════════════════════════════════════════════════════════
// TOP 10 SAHAM IDX — 5-TIER TECHNICAL SCANNER (UPGRADED)
// ═══════════════════════════════════════════════════════════════

private fun showTopStocksDialog() {
val prefs      = getSharedPreferences(IDX_CACHE_PREF, MODE_PRIVATE)
val cachedDate = prefs.getString(IDX_CACHE_DATE_KEY, null)
val cachedCnt  = prefs.getInt(IDX_CACHE_COUNT_KEY, 0)
val sdf        = makeSdfDate()
val todayKey   = sdf.format(Calendar.getInstance(WIB).time)
val cacheTag   = when {
cachedDate == todayKey && cachedCnt >= 100 -> " ✅ cached $cachedCnt"
cachedDate != null                         -> " ⚠ cache $cachedDate ($cachedCnt)"
else                                       -> " (belum pernah di-fetch)"
}

val modeLabels = arrayOf(
"⚡ Cepat       — LQ45 (~${IDX_LQ45.size} saham, paling likuid, ~10 detik)",
"📈 Papan Utama — 269 saham Blue Chip + Mid-Cap, ~25 detik",
"📊 Komprehensif— Utama + Pengembangan (762 saham, ~60 detik)",
"🔍 Full IDX    — Semua non-Khusus (803 saham, ~70 detik)",
"🌐 Auto-Fetch  — Ambil dari API BEI secara langsung$cacheTag"
)
var selectedMode = 1  // default: Papan Utama
...
text = "Data saham dari BEI 2026-06-16 (957 total).\nPemantauan Khusus (154 saham bermasalah) selalu dikecualikan."
setTextColor(Color.parseColor("#546E7A")); textSize = 11f; setPadding(0, 0, 0, 12)
}
dialogView.addView(infoLabel)

android.app.AlertDialog.Builder(this)
.setTitle("🏆 Pilih Mode Scan Saham IDX")
.setView(dialogView)
.setSingleChoiceItems(modeLabels, selectedMode) { _, which ->
selectedMode = which
}
.setPositiveButton("▶ Mulai Scan") { _, _ ->
when (selectedMode) {
0 -> launchTopStocksScan(IDX_LQ45, 8, "~10 detik", "LQ45")
1 -> launchTopStocksScan(IDX_PAPAN_UTAMA, 12, "~25 detik", "Papan Utama")
2 -> launchTopStocksScan(IDX_UTAMA_PENGEMBANGAN, 20, "~60 detik", "Utama+Pengembangan")
3 -> launchTopStocksScan(IDX_FULL_NON_KHUSUS, 24, "~70 detik", "Full IDX non-Khusus")
4 -> launchAutoFetchScan()
else -> launchTopStocksScan(IDX_PAPAN_UTAMA, 12, "~25 detik", "Papan Utama")
}
}
.setNeutralButton("🔄 Refresh Cache API") { _, _ ->
refreshIDXCache()
}
...
/** Refresh IDX cache in background, show result toast */
private fun refreshIDXCache() {
Toast.makeText(this, "🔄 Mengambil daftar saham dari API BEI...", Toast.LENGTH_SHORT).show()
Thread {
val (list, msg) = getDynamicIDXList(forceRefresh = true)
runOnUiThread {
...
/** Mode 5: Auto-Fetch — ambil dari cache/API lalu langsung scan */
private fun launchAutoFetchScan() {
val prefs      = getSharedPreferences(IDX_CACHE_PREF, MODE_PRIVATE)
val cachedDate = prefs.getString(IDX_CACHE_DATE_KEY, null)
val sdf        = makeSdfDate()
val todayKey   = sdf.format(Calendar.getInstance(WIB).time)

// If today's cache exists, use it immediately
if (cachedDate == todayKey) {
val (list, msg) = getDynamicIDXList(forceRefresh = false)
launchTopStocksScan(list, 24, "~tergantung ukuran list", "Auto-Fetch BEI")
return
}

// Need to fetch first - show progress
val progView = LinearLayout(this).apply {
orientation = LinearLayout.VERTICAL; setPadding(40, 28, 40, 28)
}
progView.addView(TextView(this).apply {
text = "🌐 Menghubungi API BEI...\nMengambil daftar saham terkini."
textSize = 14f; setTextColor(Color.parseColor("#1A237E")); setPadding(0, 0, 0, 16)
})
val progBar = android.widget.ProgressBar(this).apply { isIndeterminate = true }
progView.addView(progBar)

val fetchDialog = android.app.AlertDialog.Builder(this)
.setTitle("📡 Auto-Fetch Daftar Saham")
.setView(progView).setCancelable(false).create()
fetchDialog.show()
...
fetchDialog.dismiss()
Toast.makeText(this, msg, Toast.LENGTH_LONG).show()
val eta = "~${"%.0f".format(list.size / 12.0)} detik"
launchTopStocksScan(list, 24, eta, "Auto-Fetch BEI (${list.size} saham)")
}
}.start()
}

private fun launchTopStocksScan(stockList: List<String>, threads: Int, eta: String, modeName: String) {
val progView = LinearLayout(this).apply {
orientation = LinearLayout.VERTICAL; setPadding(40, 28, 40, 28)
}
val progBar = android.widget.ProgressBar(
this, null, android.R.attr.progressBarStyleHorizontal
).apply {
isIndeterminate = false; max = stockList.size; progress = 0
layoutParams = LinearLayout.LayoutParams(
LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT
)
}
val progText = TextView(this).apply {
text = "Mengambil data IHSG..."; textSize = 13f
setTextColor(Color.parseColor("#1A237E")); setPadding(0, 10, 0, 0)
}
progView.addView(TextView(this).apply {
text = "🔍 Scanning ${stockList.size} saham  [$modeName]"
textSize = 15f; paint.isFakeBoldText = true; setTextColor(Color.parseColor("#1A237E"))
})
progView.addView(android.view.View(this).apply {
layoutParams = LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, 10)
})
progView.addView(progBar)
progView.addView(progText)
progView.addView(TextView(this).apply {
text = "$threads koneksi paralel  •  estimasi $eta"
textSize = 11f; setTextColor(Color.DKGRAY); setPadding(0, 8, 0, 0)
})

val dialog = android.app.AlertDialog.Builder(this)
.setTitle("📊 Top 10 Saham IDX — $modeName")
.setView(progView).setCancelable(false).create()
dialog.show()

Thread {
val ihsgJson = fetchData("^JKSE")
if (ihsgJson == null) {
runOnUiThread {
dialog.dismiss()
Toast.makeText(this, "❌ Gagal ambil data IHSG. Cek koneksi internet.", Toast.LENGTH_LONG).show()
}
return@Thread
}
val ihsgData = extractYahoo(ihsgJson)
val results  = scanAllStocksForRanking(stockList, ihsgData, threads) { done, total ->
runOnUiThread {
progBar.progress = done
progText.text    = "Scanning $done/$total  •  berhasil: ${progBar.progress} data"
}
}
runOnUiThread {
dialog.dismiss()
showTopStocksResult(results, stockList.size, modeName)
}
}.start()
}

private fun scanAllStocksForRanking(
...
val results = java.util.Collections.synchronizedList(mutableListOf<StockScanResult>())
val latch   = java.util.concurrent.CountDownLatch(total)
val executor = java.util.concurrent.Executors.newFixedThreadPool(threadCount.coerceIn(4, 32))

stockList.forEach { ticker ->
executor.submit {
try {
val stockJson = fetchData("$ticker.JK")
if (stockJson != null) {
val r = scoreSingleStockTech(ticker, stockJson, ihsgData)
if (r != null) results.add(r)
}
} catch (_: Exception) {}
finally {
val cnt = scanned.incrementAndGet()
runOnUiThread { onProgress(cnt, total) }
latch.countDown()
}
}
}
...
return results.sortedByDescending { it.techScore }
}


/** Scoring teknikal murni — TERPISAH dari main engine */
private fun scoreSingleStockTech(
ticker: String, stockJson: JSONObject, ihsgData: YahooData
): StockScanResult? {
return try {
val s = extractYahoo(stockJson)
if (s.adj.size < 65 || ihsgData.adj.size < 65) return null
val t         = s.adj.lastIndex
val lastPrice = s.adj[t]
if (lastPrice <= 0) return null

val bars = minOf(60, t, ihsgData.adj.lastIndex - 1)
val sAdj = s.adj.takeLast(bars + 1)
val iAdj = ihsgData.adj.takeLast(bars + 1)
val sT   = sAdj.lastIndex; val iT = iAdj.lastIndex
if (sT < 20 || iT < 20) return null

val sRet = (1..sT).map { (sAdj[it] - sAdj[it-1]) / sAdj[it-1] }
val iRet = (1..iT).map { (iAdj[it] - iAdj[it-1]) / iAdj[it-1] }
if (sRet.size < 20 || iRet.size < 20) return null

val iRet5 = if (iT >= 5) (iAdj[iT] - iAdj[iT-5]) / iAdj[iT-5] else 0.0

val sAvg = sRet.average(); val iAvg = iRet.average()
val cov  = sRet.zip(iRet).sumOf { (a,b) -> (a-sAvg)*(b-iAvg) } / sRet.size
val varI = iRet.sumOf { (it-iAvg).pow(2) } / iRet.size
val beta = (cov / varI.coerceAtLeast(1e-8)).coerceIn(-3.0, 3.0)
val betaNorm = normalizeSignal(beta * iRet5, 0.05)

val mom3  = if (sT>=3)  (sAdj[sT]-sAdj[sT-3])  / sAdj[sT-3]  else 0.0
val mom5  = if (sT>=5)  (sAdj[sT]-sAdj[sT-5])  / sAdj[sT-5]  else 0.0
val mom10 = if (sT>=10) (sAdj[sT]-sAdj[sT-10]) / sAdj[sT-10] else 0.0
val momCombo = mom3*0.50 + mom5*0.30 + mom10*0.20
val momNorm  = normalizeSignal(momCombo, 0.05)

val (coppStd,  coppStdPrev)  = coppockCurve(sAdj, 14, 11, 10)
val (coppFast, coppFastPrev) = coppockCurve(sAdj,  6,  4,  5)
val coppRising     = coppStd  > coppStdPrev
val coppFastRising = coppFast > coppFastPrev
val isTurningUp    = coppRising && coppStdPrev  <= 0.0
val isTurningDown  = !coppRising && coppStdPrev >= 0.0
val fastAlign      = if (coppFastRising == coppRising) 1.08 else 0.92
val coppDirBase = when {
isTurningUp                     ->  1.0
coppStd > 0 && coppRising       ->  0.70
coppStd <= 0 && coppRising      ->  0.40
isTurningDown                   -> -1.0
coppStd > 0 && !coppRising      -> -0.30
else                           -> -0.70
}
val coppNorm  = (coppDirBase * fastAlign).coerceIn(-1.0, 1.0)
val coppLabel = when {
isTurningUp                     -> "🔼 Turning Up"
coppStd > 0 && coppRising       -> "↑ Rising+"
coppStd <= 0 && coppRising      -> "↑ Recovering"
isTurningDown                   -> "🔽 Turning Down"
else                           -> "↓ Bearish"
}

val sigma20 = robustStd(sRet.takeLast(20))
val sma20v  = sAdj.takeLast(20).average()
val zScoreV = (lastPrice - sma20v) / (sigma20 * sma20v).coerceAtLeast(0.001)
val mrNorm  = normalizeSignal(
if (abs(zScoreV) > 2.0) -0.3 * zScoreV else -zScoreV * 0.05, 0.05)

val volMA20   = s.vol.takeLast(20).average().coerceAtLeast(1.0)
val vol5      = s.vol.takeLast(5).average()
val volSurgeV = ((vol5 / volMA20) - 1.0).coerceIn(-1.0, 1.0)

val rsiCh = sRet.takeLast(14)
val gains  = rsiCh.filter { it > 0 }.let { if (it.isEmpty()) 0.0 else it.average() }
val losses = rsiCh.filter { it < 0 }.let { if (it.isEmpty()) 1e-6 else -it.average() }
val rsiVal  = 100.0 - (100.0 / (1.0 + gains / losses.coerceAtLeast(1e-6)))
val rsiNorm = when {
rsiVal < 25 ->  0.90; rsiVal < 35 ->  0.55; rsiVal < 45 ->  0.20
rsiVal < 55 -> -0.10; rsiVal < 65 -> -0.35; rsiVal < 75 -> -0.55
else        -> -0.80
}

val res20v        = s.high.takeLast(21).dropLast(1).maxOrNull() ?: lastPrice
val breakoutBonus = if (lastPrice > res20v * 0.995 && volSurgeV > 0.3) 0.10 else 0.0

val techScore = (momNorm*0.30 + coppNorm*0.28 + betaNorm*0.17 +
mrNorm*0.10 + volSurgeV*0.08 + rsiNorm*0.07 + breakoutBonus)
.coerceIn(-1.0, 1.0)

val signal = when {
techScore > 0.42  -> "STRONG BUY ▲▲"; techScore > 0.18  -> "BUY ▲"
techScore > 0.05  -> "WEAK BUY ▲"; techScore < -0.42 -> "STRONG SELL ▼▼"
techScore < -0.18 -> "SELL ▼"; else -> "NEUTRAL →"
}

val riskOnV  = ema(iAdj, minOf(20, iAdj.size)) > iAdj.takeLast(20).average() && iRet5 > 0
val fastVCV  = stdDev(sRet.takeLast(3)) / stdDev(sRet.takeLast(20)).coerceAtLeast(0.001)
val regime   = when {
!riskOnV && fastVCV >= 1.2 -> "PANIC"; riskOnV && fastVCV >= 1.0 -> "VOL UP"
riskOnV -> "BULLISH"; else -> "BEARISH"
}

val alphaEst = sRet.average() - beta * iRet.average()
val muEst    = (beta * iRet5 + alphaEst + momCombo * 0.15).coerceIn(-0.04, 0.04)
val tpEst    = lastPrice * (1 + muEst + 0.6 * sigma20)
val slEst    = lastPrice * (1 + muEst - 0.5 * sigma20)

StockScanResult(
ticker=ticker, techScore=techScore, signal=signal, muEst=muEst,
coppockLabel=coppLabel, lastPrice=lastPrice, tpEst=tpEst, slEst=slEst,
regime=regime, rsi=rsiVal, beta=beta, momScore=momCombo,
isCoppockTurningUp=isTurningUp, volSurge=volSurgeV, zScore=zScoreV
)
} catch (_: Exception) { null }
}

private fun showTopStocksResult(allResults: List<StockScanResult>, totalScanned: Int, modeName: String = "") {
val topBuys  = allResults.filter { it.techScore > 0.0 }.take(10)
val scanned  = allResults.size
val sdfShort = SimpleDateFormat("dd MMM yyyy", Locale("id","ID")).also { it.timeZone = WIB }
val sdfFull  = SimpleDateFormat("dd MMM yyyy HH:mm", Locale("id","ID")).also { it.timeZone = WIB }
val now      = Calendar.getInstance(WIB)

val scroll    = ScrollView(this)
val container = LinearLayout(this).apply {
orientation = LinearLayout.VERTICAL; setPadding(16,16,16,24)
setBackgroundColor(Color.parseColor("#F5F5F5"))
}

container.addView(TextView(this).apply {
text = "🏆 TOP ${topBuys.size} REKOMENDASI BELI BESOK"
setTextColor(Color.parseColor("#1A237E")); textSize = 16f; paint.isFakeBoldText = true
})
container.addView(TextView(this).apply {
val sessKey = getEvaluationSessionKey(System.currentTimeMillis())
val modeStr = if (modeName.isNotEmpty()) "Mode: $modeName  |  " else ""
text = "${modeStr}Scan: ${sdfFull.format(now.time)} WIB  •  Sesi: $sessKey\n" +
"Berhasil scan: $scanned/$totalScanned saham (gagal/kosong: ${totalScanned-scanned})\n" +
"Faktor: Momentum(30%) + Coppock(28%) + Beta(17%) + MeanRev(10%) + Volume(8%) + RSI(7%)\n" +
"⚠ Tanpa AI Gemini & Broker Data — Independent dari main engine"
setTextColor(Color.DKGRAY); textSize = 11f; setPadding(0, 4, 0, 14)
})

if (topBuys.isEmpty()) {
container.addView(TextView(this).apply {
text = "⚠ Tidak ada saham dengan sinyal positif saat ini.\nKondisi pasar mungkin sedang bearish secara umum."
setTextColor(Color.parseColor("#B71C1C")); textSize = 13f; setPadding(0,8,0,8)
})
} else {
topBuys.forEachIndexed { idx, r ->
val rank     = idx + 1
val barLen   = (r.techScore * 10).toInt().coerceIn(0, 10)
val scoreBar = "█".repeat(barLen) + "░".repeat(10 - barLen)
val cardBg   = if (r.isCoppockTurningUp) Color.parseColor("#E8F5E9") else Color.WHITE

val card = LinearLayout(this).apply {
orientation = LinearLayout.VERTICAL
setBackgroundColor(cardBg); setPadding(16, 14, 16, 14)
val lp = LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT)
lp.setMargins(0, 0, 0, 10); layoutParams = lp
}

val hRow = LinearLayout(this).apply { orientation = LinearLayout.HORIZONTAL }
val badge = when (rank) { 1->"🥇"; 2->"🥈"; 3->"🥉"; else->"#$rank " }
hRow.addView(TextView(this).apply {
text = "$badge ${r.ticker}"
setTextColor(Color.parseColor("#1A237E")); textSize = 17f; paint.isFakeBoldText = true
layoutParams = LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1f)
})
hRow.addView(TextView(this).apply {
text = "${getTickRoundNearest(r.lastPrice)}"
setTextColor(Color.parseColor("#37474F")); textSize = 15f; paint.isFakeBoldText = true
gravity = android.view.Gravity.END
})
card.addView(hRow)
card.addView(android.view.View(this).apply {
setBackgroundColor(Color.parseColor("#E0E0E0"))
layoutParams = LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, 1).also { it.setMargins(0,6,0,6) }
})

val sigCol = when {
r.signal.contains("STRONG BUY") -> Color.parseColor("#1B5E20")
r.signal.contains("BUY")        -> Color.parseColor("#2E7D32")
else                           -> Color.parseColor("#E65100")
}
card.addView(TextView(this).apply {
text = r.signal; setTextColor(sigCol); textSize = 15f; paint.isFakeBoldText = true; setPadding(0,0,0,3)
})
card.addView(TextView(this).apply {
text = "Score: ${"%.3f".format(r.techScore)}  $scoreBar"
setTextColor(Color.parseColor("#0D47A1")); textSize = 12f; paint.isFakeBoldText = true; setPadding(0,0,0,5)
})

fun row(label: String, value: String, col: Int) {
val rv = LinearLayout(this).apply { orientation = LinearLayout.HORIZONTAL }
rv.addView(TextView(this).apply {
text = label; setTextColor(Color.parseColor("#90A4AE")); textSize = 12f
layoutParams = LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1f)
})
rv.addView(TextView(this).apply {
text = value; setTextColor(col); textSize = 12f; paint.isFakeBoldText = true
layoutParams = LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1.6f)
})
card.addView(rv)
}

row("Coppock", r.coppockLabel,
if (r.isCoppockTurningUp) Color.parseColor("#1B5E20") else Color.parseColor("#546E7A"))
row("Est. Return",
"${"%.2f".format(r.muEst*100)}%  ${if(r.muEst>0.01)"🟢" else if(r.muEst>0)"🟡" else "🔴"}",
if (r.muEst>0) Color.parseColor("#2E7D32") else Color.RED)
row("Est. TP Besok", "${getTickRound(r.tpEst,true)}", Color.parseColor("#1B5E20"))
row("Est. SL Besok", "${getTickRound(r.slEst,false)}", Color.parseColor("#B71C1C"))
row("RSI-14",
"${"%.1f".format(r.rsi)}  ${when{r.rsi<30->"⚡ Oversold";r.rsi<40->"↓ Lemah";r.rsi<60->"Normal";r.rsi<70->"↑ Kuat";else->"🔴 Overbought"}}",
when{r.rsi<40->Color.parseColor("#2E7D32");r.rsi>70->Color.RED;else->Color.DKGRAY})
row("Volume Surge",
"${"%.0f".format(r.volSurge*100)}%  ${if(r.volSurge>0.3)"⬆ Tinggi" else if(r.volSurge>0)"Normal" else "⬇ Rendah"}",
if(r.volSurge>0.3) Color.parseColor("#E65100") else Color.DKGRAY)
row("Z-Score",
"${"%.2f".format(r.zScore)}σ  ${if(r.zScore<-2.0)"Oversold↑" else if(r.zScore>2.0)"Overbought↓" else "Normal"}",
if(abs(r.zScore)>2.0) Color.parseColor("#E65100") else Color.DKGRAY)
row("Beta | Mom", "${"%.2f".format(r.beta)}β | ${"%.2f".format(r.momScore*100)}%", Color.parseColor("#546E7A"))
row("Regime", r.regime,
when(r.regime){"BULLISH"->Color.parseColor("#2E7D32");"PANIC"->Color.RED;else->Color.DKGRAY})

if (r.isCoppockTurningUp) {
card.addView(TextView(this).apply {
text = "  ⚡ Coppock Turning Up — Sinyal Akumulasi Terkuat ✅"
setTextColor(Color.parseColor("#1B5E20")); textSize = 11f
paint.isFakeBoldText = true; setPadding(0, 6, 0, 0)
})
}
...
container.addView(TextView(this).apply {
text = "📌 DISCLAIMER: Ranking ini bersifat informatif berbasis analisis teknikal saja " +
"(tanpa analisis fundamental, sentimen berita, dan data broker). " +
"Bukan rekomendasi investasi resmi. Keputusan trading sepenuhnya " +
"merupakan tanggung jawab trader. Selalu DYOR."
setTextColor(Color.parseColor("#B71C1C")); textSize = 11f; setPadding(0, 18, 0, 0)
})

scroll.addView(container)
android.app.AlertDialog.Builder(this)
.setTitle("🏆 Top ${topBuys.size} Saham IDX — ${sdfShort.format(now.time)}")
.setView(scroll)
.setPositiveButton("✕  Tutup", null)
.create().also { d ->
d.show()
...
"Coppock Curve"      to "Indikator momentum jangka menengah karya Edwin Coppock (1962). Dihitung sebagai WMA dari jumlah dua Rate-of-Change: WMA(wP)[ROC(rP1)+ROC(rP2)]. Awalnya dirancang untuk data bulanan, diadaptasi ke daily di sini.",
"Coppock Std (14,11,10)" to "Versi standard harian: ROC(14)+ROC(11) dihaluskan WMA(10). Menangkap pergerakan medium-term ~2-3 minggu.",
"Coppock Fast (6,4,5)"   to "Versi cepat harian: ROC(6)+ROC(4) dihaluskan WMA(5). Lebih responsif, digunakan sebagai konfirmasi sinyal standard.",
"Coppock Turning Up"  to "SINYAL BELI KLASIK: Coppock berbalik naik dari zona negatif. Ini sinyal terkuat — historis menandai akhir bear market / akumulasi besar.",
"Coppock Turning Down" to "SINYAL JUAL KLASIK: Coppock berbalik turun dari zona positif. Menandai melemahnya momentum bull.",
"Coppock Rising Positive" to "Coppock di atas nol dan masih naik → tren naik sehat. Konfirmasi BUY.",
"Coppock Recovering"  to "Coppock masih negatif tapi sudah naik → awal pemulihan. Sinyal moderat BUY.",
"WMA (Weighted MA)"   to "Weighted Moving Average: bobot linier, data terbaru = bobot terbesar. Lebih responsif dari SMA.",
"ROC (Rate of Change)" to "Perubahan harga relatif: (Close - Close[n]) / Close[n] × 100. Mengukur momentum persentase.",
"Coppock Signal"      to "Nilai ternormalisasi [-1,+1] dari Coppock. Menggabungkan direction score (65%) dan magnitude score (35%). Digunakan sebagai faktor ke-6 dalam consensus engine.",
"Fast Conf (Coppock)" to "Jika Coppock Fast searah Coppock Std → sinyal +10% lebih kuat. Jika berlawanan → −10% (divergensi).",
...
"Papan Utama"   to "Papan pencatatan BEI untuk perusahaan blue-chip & mid-cap terkemuka. Tier 2 scan (269 saham, 2026-06-16).",
"Papan Pengembangan" to "Papan pencatatan BEI untuk perusahaan berkembang. Digabung dengan Utama di Tier 3 (762 saham total).",
"Akselerasi"    to "Papan BEI untuk startup & UMKM. Termasuk di Tier 4 Full IDX (803 saham total).",
"Pemantauan Khusus" to "Saham yang sedang diawasi khusus BEI (suspensi, masalah keuangan, dll). SELALU dikecualikan dari semua scan.",
"Auto-Fetch BEI" to "Tier 5 scan: mengambil daftar saham langsung dari API idx.co.id setiap hari. Cache 24 jam. Fallback ke static list jika API gagal.",
"IDX Cache"     to "Penyimpanan lokal daftar saham BEI. Diperbarui sekali sehari dari API BEI. Lihat tombol 'Refresh Cache API' di dialog scan.",
"5 Tier Scan"   to "Mode scan Top 10: Cepat=LQ45(~51), Utama=269, Komprehensif=762, Full=803, Auto-Fetch=dinamis dari BEI."
)
...
val dateStr=if(ts>0) sdfOut.format(java.util.Date(ts)) else "—"
